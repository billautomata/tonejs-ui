export default function MonoSynth () {
  return {
    ...
    'knobs': [
      { knobType: 'circle', position: { x: 40, y: 165 }, size: 50, name: 'Level', attribute: 'volume', outputRange: [-100, 0], defaultValue: -10, value: 20 },
      { knobType: 'circle', position: { x: 40, y: 60 }, size: 50, name: 'Detune', attribute: 'detune', outputRange: [-50, 50], defaultValue: 0, value: 50 },
      { knobType: 'slider', position: { x: 150, y: 95 }, size: 50, name: 'A', attribute: 'envelope.attack', outputRange: [0, 5], defaultValue: 1, value: 50 },
      { knobType: 'slider', position: { x: 185, y: 95 }, size: 50, name: 'D', attribute: 'envelope.decay', outputRange: [0, 5], defaultValue: 1, value: 20 },
      { knobType: 'slider', position: { x: 220, y: 95 }, size: 50, name: 'S', attribute: 'envelope.sustain', outputRange: [0, 1], defaultValue: 1, value: 70 },
      { knobType: 'slider', position: { x: 255, y: 95 }, size: 50, name: 'R', attribute: 'envelope.release', outputRange: [0, 5], defaultValue: 1, value: 80 },
      ...
      { knobType: 'slider', position: { x: 390, y: 95 }, size: 50, name: 'A', attribute: 'filterEnvelope.attack', outputRange: [0, 5], defaultValue: 1, value: 50 },
